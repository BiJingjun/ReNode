...
def get_opt():
    ...
    parser.add_argument('--data-name',  default='scence', type=str, help="data name")#cora citeseer pubmed photo computers
    parser.add_argument('--size-imb-type', default='none', type=str, help="the imbalace type of the training set") #none, step
    parser.add_argument('--train-each', default=50, type=int, help="the training size of each class, used in none imbe type")
    parser.add_argument('--valid-each', default=100, type=int, help="the validation size of each class")
    ...
    #ReNode
    parser.add_argument('--renode-reweight', '-rr',   default=1,   type=int,   help="switch of ReNode") # 0 (not use) or 1 (use)
    parser.add_argument('--rn-base-weight',  '-rbw',  default=0.5, type=float, help="the base  weight of renode reweight")#0.5
    parser.add_argument('--rn-scale-weight', '-rsw',  default=30.0, type=float, help="the scale weight of renode reweight")
